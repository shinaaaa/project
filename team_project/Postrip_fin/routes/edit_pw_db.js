...
router.post('/', function (req, res, next) {
  ...
  console.log("asdasdasdasdasd :" + pw_confirm());
  
  if (pw_confirm() == 1) {
    res.send("1");
  }
  else if (pw_confirm() == 2) {
    res.send("2");
  }
  else if (pw_confirm() == 3) {
    res.send("3");
  }
  else if (pw_confirm() == 4) {
    res.send("4");
  }
  else if (pw_confirm() == 5) {
    update();
  } else {
    res.send("6");
  }
